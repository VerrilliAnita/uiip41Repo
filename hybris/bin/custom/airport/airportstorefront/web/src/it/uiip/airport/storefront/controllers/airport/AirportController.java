...
public class AirportController extends AbstractPageController {
	...
	@Resource(name = "ticketAirportFacade")
	private TicketAirportFacade ticketAirportFacade;
	...
	public String searchAirportByCity(@PathVariable("city") final String city, final Model model,
