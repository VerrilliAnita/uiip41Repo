...
import it.uiip.airport.core.service.impl.DefaultCabinCrewService;

public class BestCabinCrewJob extends AbstractJobPerformable<CronJobModel> {

	private DefaultCabinCrewService cabinCrewService;
   ...
   @Override
    public PerformResult perform(CronJobModel arg0) {
        ...
        final List<CabinCrewModel> allCabinCrewes = cabinCrewService.getAllCabinCrew();
	...
	public DefaultCabinCrewService getCabinCrewService() {
		return cabinCrewService;
	}

	@Required
	public void setCabinCrewService(DefaultCabinCrewService cabinCrewService) {
